...
export STUDENT_CKPT=/workspace/torchtitan_attention_residual/phase4_kimi_attnres_lm_pretrain/runs/lm_447m_base/checkpoint/step-12500
...
export OUT_DIR="${OUT_DIR:-/workspace/torchtitan_attention_residual/phase5_vlm_multimodal_sft/runs/mm_sft_smoke}"

exec bash phase5_vlm_multimodal_sft/launch_train.sh
