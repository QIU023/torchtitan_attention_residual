"""Variable image count per row (B1 from phase6_upstream_pr_prep/README).
...
``phase5_vlm_multimodal_sft/multimodal_model.py:multimodal_loss``). Real VLM data violates
