...
import phase6_upstream_pr_prep.torchtitan_pp_backward_hotfix  # noqa: E402,F401
import phase6_upstream_pr_prep.torchtitan_pp_retain_graph_diag  # noqa: E402,F401  diagnostic, env-gated
...
from phase5_vlm_multimodal_sft.multimodal_model import Projector  # noqa: E402
...
class MultimodalTrainer(Trainer):
    def __init__(self, config, *,
        ...
        from phase5_vlm_multimodal_sft.sentinel_registry import resolve_sentinel  # noqa: E402
        try:
    ...
    def _build_mm_dataset(self, *, split: str, infinite: bool):
        ...
        if self._mm_layout == "sft":
            ...
            from phase5_vlm_multimodal_sft.multimodal_dataset_interleave import (
