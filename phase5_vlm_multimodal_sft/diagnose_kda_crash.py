...
The full SFT run (phase5_vlm_multimodal_sft/runs/mm_sft_447m_full) trained healthily for
...
It does NOT touch the GPU. Run:  /usr/bin/python3 phase5_vlm_multimodal_sft/diagnose_kda_crash.py
"""
