...
WORKSPACE = Path("/root/torchtitan_attention_residual/phase5_vlm_multimodal_sft/runs")
RUNS = {
...
out = Path("/root/torchtitan_attention_residual/phase8_vqa_eval/eval_results/loss_curves.json")
