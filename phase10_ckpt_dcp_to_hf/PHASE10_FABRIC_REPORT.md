...
| Path | Size | Source |
|---|---|---|
| `phase5_vlm_multimodal_sft/runs/v11_4d_*/tier_b_trace/ixia_config.json` | 30 KB | v11 5000-step training |
| `phase5_vlm_multimodal_sft/runs/v12_trace_50step/tier_b_trace/ixia_config.json` | 24 KB | v12 50-step post-hoc |
| `phase5_vlm_multimodal_sft/runs/sft_v11_*/tier_b_trace/ixia_config.json` | 30 KB | SFT 490-step |
| `phase5_vlm_multimodal_sft/runs/5d_mode_b_*/tier_b_trace/ixia_config.json` | 29 KB | llama3 PP=2×FSDP=2×CP=2 |
| `phase5_vlm_multimodal_sft/runs/ppo_smoke_no_vllm/tier_b_trace/ixia_config.json` | 6.3 KB | toy PPO cross-mesh |
| `phase5_vlm_multimodal_sft/runs/inference_torchtitan_phase4_step8000/tier_b_trace/ixia_config.json` | 29 KB | **Stage D inference** |
| `phase5_vlm_multimodal_sft/runs/ppo_real_torchtitan/tier_b_trace/ixia_config.json` | ~30 KB | **Stage F real PPO** |

Plus older alignment-matrix traces from Phase 6 (8gpu_a2/a3/b0 — see
`phase7_nccl_traffic_catalog/FINAL_CATALOG.md`).

## Stage I — Two-phase TP RS+AG synthetic demo

`phase10_ckpt_dcp_to_hf/TWO_PHASE_TP_FABRIC_DEMO.md`. Two modes side-by-side:
...
`phase10_ckpt_dcp_to_hf/AUTOREGRESSIVE_FABRIC.md`. 20 generations × 20 tokens (no
...
`phase10_ckpt_dcp_to_hf/TWO_PHASE_REAL_MODEL_FABRIC.md`. Real kimi_linear AttnRes
...
`phase10_ckpt_dcp_to_hf/SUSTAINED_INFERENCE_WORKLOAD.md`. 4 production-volume
workload shapes:
...
3. **commId-aware axis labels**: requires upstream
   ...
   output. Heuristic in `phase7_nccl_traffic_catalog/expand_to_flows.py` conflates PP and
