...
Run (single-rank DCP load is enough — HF format is replicated):
    torchrun --nproc_per_node=1 phase10_ckpt_dcp_to_hf/dcp_to_hf_kimi_attn_res.py \\
        --in phase4_kimi_attnres_lm_pretrain/runs/kimi_436m_block_attn_res_fsdp/checkpoint/step-8000 \\
        --out phase10_ckpt_dcp_to_hf/hf_ckpt_phase4_step8000 \\
