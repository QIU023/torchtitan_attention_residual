...
#
# Usage:
#   bash phase4_kimi_attnres_lm_pretrain/launch_pp4_kimi.sh                # default 100-step smoke
#   STEPS=1000 LOCAL_BS=2 bash phase4_kimi_attnres_lm_pretrain/launch_pp4_kimi.sh
#
# Env overrides:
