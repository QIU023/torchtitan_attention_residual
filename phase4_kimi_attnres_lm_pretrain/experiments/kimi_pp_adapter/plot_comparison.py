...
PHASE4_RUNS = Path("/root/torchtitan_attention_residual/phase4_kimi_attnres_lm_pretrain/runs")
LOGS = OrderedDict([
...
def main():
    ...
    ap.add_argument("--out", default="/root/torchtitan_attention_residual/phase4_kimi_attnres_lm_pretrain/runs/kimi_pp_adapter_bench/comparison.png")
