...
- 训练日志：`phase3/runs/{pp4_naive_4gpu,pp4_adapter_4gpu,pp4_adapter_4gpu_smoke1k}/train.log`
- 头条图：`phase3/naive_vs_adapter_loss.png`
- 设计 + handoff：`phase3/adapter_design.md`、`handoff_status_20260420{,_part2,_part3}.md`、`handoff_status_20260421.md`
