...
# resolved (see phase11_rlhf_grpo_infra/VISION_INJECTION_BUG_RCA.md).
#
...
exec timeout 3900 /usr/bin/python3 phase11_rlhf_grpo_infra/rlhf/run_grpo_llava_kimi.py \
    --dcp-load-path "${PWD}/phase5_vlm_multimodal_sft/runs/mm_sft_447m_full/checkpoint/step-3100" \
    --hf-model-path "${PWD}/phase5_vlm_multimodal_sft/runs/mm_sft_447m_full/hf_step3100" \
    --num-steps 500 \
