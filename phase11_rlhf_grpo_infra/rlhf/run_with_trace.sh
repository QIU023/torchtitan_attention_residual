...
#   phase7_nccl_traffic_catalog/expand_to_flows.py
#   phase7_nccl_traffic_catalog/flows_to_ixia.py
#
# Output structure mirrors phase11_rlhf_grpo_infra/trace_*/ inference dirs:
#   phase11_rlhf_grpo_infra/rlhf/trace_grpo_llava/
...
#
# Usage:
#   bash phase11_rlhf_grpo_infra/rlhf/run_with_trace.sh [--text-only]
set -uo pipefail

WS=/root/torchtitan_attention_residual
TRACE_DIR=${TRACE_DIR:-$WS/phase11_rlhf_grpo_infra/rlhf/trace_grpo_llava}
MODEL_PATH=${MODEL_PATH:-$WS/phase11_rlhf_grpo_infra/hf/lm_base}
...
timeout 1800 python3 phase11_rlhf_grpo_infra/rlhf/run_grpo_llava_caption.py \
