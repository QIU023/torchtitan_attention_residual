...
Usage:
    ...
    bash phase11_rlhf_grpo_infra/rlhf/run_grpo_sum_digits_with_trace.sh
...
(``phase11_rlhf_grpo_infra/rlhf/trace_grpo_qwen3_*``).
"""
...
class _Config(Configurable.Config):
    ...
    hf_assets_path: str = ""
    num_steps: int = 50
    dump_folder: str = "phase11_rlhf_grpo_infra/rlhf/outputs/grpo_sum_digits"
