...
Usage:
    python3 phase11_rlhf_grpo_infra/bench_attn_res.py --model phase11_rlhf_grpo_infra/hf/lm_base \
        --tp 1
    python3 phase11_rlhf_grpo_infra/bench_attn_res.py --model phase11_rlhf_grpo_infra/hf/lm_base \
        --tp 8
...
def main():
    ...
    ap.add_argument("--out", default="phase11_rlhf_grpo_infra/bench_results.json")
    args = ap.parse_args()
