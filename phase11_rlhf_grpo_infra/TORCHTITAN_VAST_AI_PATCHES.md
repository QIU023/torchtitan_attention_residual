...
**Patch file:** `phase11_rlhf_grpo_infra/torchtitan_vast_ai_env_compat.patch` (203 lines, 5 files)
...
cd torchtitan && git apply ../phase11_rlhf_grpo_infra/torchtitan_vast_ai_env_compat.patch
```

To regenerate this patch file after editing torchtitan locally:
```bash
cd torchtitan && git diff HEAD > ../phase11_rlhf_grpo_infra/torchtitan_vast_ai_env_compat.patch
```
