...
Usage:
  python3 phase11_rlhf_grpo_infra/probe_memory.py --shard 0
  python3 phase11_rlhf_grpo_infra/probe_memory.py --shard 1
  diff the two
"""
...
def main():
    ...
    ap.add_argument("--model",
                    default="/root/torchtitan_attention_residual/phase11_rlhf_grpo_infra/hf/lm_base")
    ...
    out_dir = Path("/root/torchtitan_attention_residual/phase11_rlhf_grpo_infra/bench_results")
