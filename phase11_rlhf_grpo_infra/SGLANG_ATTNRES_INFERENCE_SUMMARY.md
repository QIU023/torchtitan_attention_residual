...
| Chunked-prefill compatibility | ✅ stress-tested (8K prompt × 2K chunks) | `phase11_rlhf_grpo_infra/PHASE11_SGLANG_REPORT.md` task #12 |
...
The lesson is in `phase11_rlhf_grpo_infra/PROFILING_REPORT.md`: bench/profile
...
| Multimodal model class (SigLIP+projector) | Spec'd in `phase11_rlhf_grpo_infra/rlhf/README.md`; not implemented |
...
e = Engine(
    model_path="phase11_rlhf_grpo_infra/hf_aligned_447m_step12500",  # or any HF ckpt with arch=KimiBlockAttnResForCausalLM
    tp_size=8,
    dtype="bfloat16",
...
4. **Examples ready**: `phase11_rlhf_grpo_infra/dump_aligned_smoke.py` produces a
...
* Reports: `phase11_rlhf_grpo_infra/PHASE11_SGLANG_REPORT.md`,
  `phase11_rlhf_grpo_infra/SGLANG_ATTNRES_AUDIT.md`, `phase11_rlhf_grpo_infra/PROFILING_REPORT.md`,
  `phase11_rlhf_grpo_infra/B5_ATTNRES_INFERENCE_KV_CACHE.md`
