...
Reverse of ``phase10_ckpt_dcp_to_hf/dcp_to_hf_kimi_attn_res.py``. Builds an empty
...
Usage::
    ...
    PYTHONPATH=torchtitan:. python phase11_rlhf_grpo_infra/hf_to_dcp_kimi_attn_res.py \\
        --in /root/torchtitan_attention_residual/phase11_rlhf_grpo_infra/hf/vlm_sft_3ep \\
        --out /workspace/torchtitan_attention_residual/phase5_vlm_multimodal_sft/runs/vlm_447m_sft_3ep/checkpoint/step-0 \\
