...
MODEL=/root/torchtitan_attention_residual/phase11_rlhf_grpo_infra/hf/lm_base
OUT_DIR=/root/torchtitan_attention_residual/phase11_rlhf_grpo_infra/bench_results
mkdir -p "$OUT_DIR"
...
for tp in 1 8; do
  for prefill in 4096 8192 16384 24576; do
    ...
    echo "============================================================"
    python3 phase11_rlhf_grpo_infra/bench_attn_res.py \
        --model "$MODEL" --tp "$tp" \
