...
#
# Mirror of phase9_post_training_ppo_trace/run_sft_pretrain.sh swapping in:
...
#   * 447M base ckpt at phase4_kimi_attnres_lm_pretrain/runs/.../step-12500
...
BASE_CKPT="$WORKSPACE_DIR/phase4_kimi_attnres_lm_pretrain/runs/lm_447m_base/checkpoint/step-12500"
OUT_DIR="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/vlm_447m_sft_instruct"
...
mkdir -p "$OUT_DIR"
LOG="$WORKSPACE_DIR/phase11_rlhf_grpo_infra/sft_447m_orchestrator.log"
exec >>"$LOG" 2>&1
