...
Usage::
    ...
    bash phase11_rlhf_grpo_infra/post_sft_vlm_smoke.sh   # converts SFT ckpt first
    python phase11_rlhf_grpo_infra/eval_vlm_qualitative.py \\
        --model-path phase11_rlhf_grpo_infra/hf/vlm_sft_1ep \\
        --num-images 10
"""
