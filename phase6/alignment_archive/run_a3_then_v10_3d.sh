...
# 5000 steps, from phase4/step-8000. Tier B trace on first 50 steps.
#
...
ORCH_LOG="$WORKSPACE_DIR/phase6/a3_v10_3d_orchestrator.log"
A3_LOG="$WORKSPACE_DIR/phase5/runs/8gpu_a3_fsdp2_pp2_tp2_seed42/train.log"
...
bash "$WORKSPACE_DIR/phase6/run_alignment_reports.sh" || true
echo "[$(date)] extracting collectives"
/venv/main/bin/python "$WORKSPACE_DIR/phase7/extract_collectives.py" \
    "$WORKSPACE_DIR/phase5/runs/8gpu_a3_fsdp2_pp2_tp2_seed42/tier_c_trace/" || true
/venv/main/bin/python "$WORKSPACE_DIR/phase7/build_pattern_catalog.py" || true
...
V10_OUT="$WORKSPACE_DIR/phase5/runs/v10_3d_continue_8gpu_from_p4_step8000"
rm -rf "$V10_OUT"
