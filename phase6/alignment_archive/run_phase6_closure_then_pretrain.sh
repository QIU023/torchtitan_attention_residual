...
ARM1P_CKPT="${WORKSPACE_DIR}/phase5/runs/arm1prime_fsdp_seed42_from_p4_8k/checkpoint/step-4000"
...
A6_LOG="${WORKSPACE_DIR}/phase5/runs/a6_fsdp2_pp2_gbs12_seed42/train.log"
while true; do
...
# ------------------------------------------------------------------
A4_DIR="${WORKSPACE_DIR}/phase5/runs/a4_async_dcp_smoke"
...
# ------------------------------------------------------------------
A5_DIR="${WORKSPACE_DIR}/phase5/runs/a5_mid_save_resume_smoke"
...
# ------------------------------------------------------------------
PT_DIR="${WORKSPACE_DIR}/phase5/runs/overnight_mm_pretrain_bs64_seed42"
