...
# of each alignment run. Output goes to phase5/runs/<config_id>/.
#
...
ORCH_LOG="${WORKSPACE_DIR}/phase6/orchestrator_8gpu_alignment.log"
exec >>"$ORCH_LOG" 2>&1
...
if pgrep -f "phase5.train_mm" >/dev/null 2>&1; then
    echo "[warn] phase5.train_mm running; killing"
