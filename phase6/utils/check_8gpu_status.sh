...
ps -ef | grep -E "phase5.train_mm|run_remaining|run_v10|run_tier_b_a" | grep -v grep | awk '{print $2, $11, $12}' | head -20
...
tail -5 phase6/orchestrator_8gpu.log 2>/dev/null
