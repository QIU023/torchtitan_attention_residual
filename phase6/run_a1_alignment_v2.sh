...
#   stage 3: compare_pp_vs_fsdp.py → phase6/alignment_report_arm2_real_mm.txt.
#
...
ARM1A_DIR="${WORKSPACE_DIR}/phase5/runs/arm1align_fsdp_gbs12_seed42"
ARM2_DIR="${WORKSPACE_DIR}/phase5/runs/arm2_pp4v2_adapter_gbs12_seed42"
...
if pgrep -f "phase5.train_mm" >/dev/null 2>&1; then
    echo "[$(date)] WARNING: phase5.train_mm still running, killing"
