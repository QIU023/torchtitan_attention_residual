...
run_mode() {
    local mode=$1
    local OUT=$WS/phase5/runs/inference_autoregressive_${mode}
    ...
    torchrun \
        ...
        -m phase10.inference_autoregressive \
        --ckpt "$CKPT" \
        --mode "$mode" \
        --n-generations 20 \
        --n-tokens 20 \
...
echo "  $WS/phase5/runs/inference_autoregressive_growing/tier_b_trace/"
echo "  $WS/phase5/runs/inference_autoregressive_single_token/tier_b_trace/"
echo "================================================================"
