...
* `phase10/inference_two_phase_real.py` — Stage D inference + per-step
  injected RS + AG ops at real-model attention shape.
* `phase10/run_two_phase_real.sh` — runner.
* `phase5/runs/inference_two_phase_real/tier_b_trace/` — trace
