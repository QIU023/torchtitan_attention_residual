...
Usage:
    python phase2_attnres_baseline_loss/plot_ablation.py \
        --baseline phase2_attnres_baseline_loss/runs/baseline \
        --runs N6=phase2_attnres_baseline_loss/runs/attn_res \
               N3=phase2_attnres_baseline_loss/runs/ablation/llama3_175m_attn_res_n3 \
               N12=phase2_attnres_baseline_loss/runs/ablation/llama3_175m_attn_res_n12 \
        --out phase2_attnres_baseline_loss/runs/ablation/comparison.png
"""
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        nargs="+",
        required=True,
        help="Key=path entries, e.g. N6=phase2_attnres_baseline_loss/runs/attn_res",
    )
