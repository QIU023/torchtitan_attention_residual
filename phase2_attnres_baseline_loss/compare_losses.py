...
Usage:
    python phase2_attnres_baseline_loss/compare_losses.py \
        --baseline phase2_attnres_baseline_loss/runs/baseline/tb \
        --attn_res phase2_attnres_baseline_loss/runs/attn_res/tb \
        --out phase2_attnres_baseline_loss/runs/comparison.png
"""
