...
```
phase8/run_vqa_eval.sh         # entry: per-ckpt × per-benchmark grid
phase8/dcp_to_hf.py            # DCP shards → HF-style state_dict
phase8/lmms_eval_adapter.py    # plugs kimi_linear + AttnRes into lmms-eval
phase8/eval_results/           # JSON outputs per (ckpt, benchmark)
```
