...
#
# Reuses phase5/generate_caption.py (already DCP-loads single-rank
# from sharded ckpt + runs greedy decode without KV cache).
#
# Outputs:
#   phase8/eval_results/qual_vqa_<ckpt_label>.txt
#   phase8/eval_results/qual_vqa_summary.md  (side-by-side compare)
set -u

WORKSPACE_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
RESULTS_DIR="$WORKSPACE_DIR/phase8/eval_results"
mkdir -p "$RESULTS_DIR"

# 3 ckpts to compare
declare -A CKPTS=(
    ["v11"]="$WORKSPACE_DIR/phase5/runs/v11_4d_fsdp2_pp2_tp2_ep2_continue_8gpu_from_p4_step8000/checkpoint/step-5000"
    ["v12"]="$WORKSPACE_DIR/phase5/runs/v12_4d_fsdp2_dp2_pp2_ep2_continue_8gpu_from_p4_step8000/checkpoint/step-5000"
    ["sft490"]="$WORKSPACE_DIR/phase5/runs/sft_v11_llava_instruct_150k_4d/checkpoint/step-490"
)
