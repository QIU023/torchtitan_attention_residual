...
#   STUDENT_CKPT=$WORKSPACE/phase4_kimi_attnres_lm_pretrain/runs/.../step-8000
#   SEED=42
#   DETERMINISTIC=1
#   COMPILE=1
...
STUDENT_CKPT="${STUDENT_CKPT:-${WORKSPACE_DIR}/phase4_kimi_attnres_lm_pretrain/runs/kimi_436m_block_attn_res_fsdp/checkpoint/step-8000}"
SEED="${SEED:-42}"
...
if [[ "$RESUME" == "1" ]]; then
    ...
    # ridiculously high). See phase6_upstream_pr_prep/CHECKPOINT_RULES.md for the rule.
