...
| Path | Loss | Purpose |
|---|---|---|
| `phase4_kimi_attnres_lm_pretrain/.../checkpoint/step-8000` | C4 val 3.23 | LM-only Phase 4 anchor |
| `phase5_vlm_multimodal_sft/runs/arm1prime_fsdp_seed42_from_p4_8k/checkpoint/step-4000` | 3.03 | original GBS=32 caption story |
| `phase5_vlm_multimodal_sft/runs/v8_pretrain_resilient_from_v7_step800/checkpoint/step-10000` | 2.07 | v8 final, mm_projector |
| **`phase5_vlm_multimodal_sft/runs/v9_continue_from_v8_step10000/checkpoint/step-5000`** | **1.81** | **session champion**, mm_projector |
