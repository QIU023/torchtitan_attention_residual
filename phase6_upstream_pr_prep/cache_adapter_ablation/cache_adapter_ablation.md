...
output at `phase6_upstream_pr_prep/c1_adapter_vs_naive_report.txt`, per-step deltas at
`phase6_upstream_pr_prep/c1_adapter_vs_naive.csv`, plot at `phase6_upstream_pr_prep/c1_adapter_vs_naive.png`):
