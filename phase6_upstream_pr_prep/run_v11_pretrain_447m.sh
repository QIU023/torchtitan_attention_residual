...
PHASE4_CKPT="$WORKSPACE_DIR/phase4_kimi_attnres_lm_pretrain/runs/lm_447m_base/checkpoint/step-12500"
OUT_DIR="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/v11_4d_447m_aligned_continue_from_step12500"

mkdir -p "$OUT_DIR"
LOG="$WORKSPACE_DIR/phase6_upstream_pr_prep/v11_447m_orchestrator.log"
exec >>"$LOG" 2>&1
...
while [[ $attempt -lt $MAX_RETRIES ]]; do
    ...
    # Disk pre-flight + per-attempt cleanup; see phase6_upstream_pr_prep/DISK_DISCIPLINE.md.
