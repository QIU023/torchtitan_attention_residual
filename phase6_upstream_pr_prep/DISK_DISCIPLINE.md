...
`phase5_vlm_multimodal_sft/runs/`. Failure to follow these rules has filled the 200 GB
...
5. **Don't pre-emptively cache compressed CSV alongside raw**. After
   `phase7_nccl_traffic_catalog/extract_collectives.py`, immediately delete the raw
