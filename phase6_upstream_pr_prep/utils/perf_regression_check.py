...
Designed for a CI step like::
    ...
    bash phase5_vlm_multimodal_sft/launch_train.sh STEPS=50 OUT_DIR=/tmp/perf_smoke
    python phase6_upstream_pr_prep/perf_regression_check.py /tmp/perf_smoke/train.log \\
...
Usage::
    ...
    python phase6_upstream_pr_prep/perf_regression_check.py <train.log> --config <name> [--tolerance 0.05]
