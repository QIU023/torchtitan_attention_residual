...
#
# Run via:
#   nohup bash phase6_upstream_pr_prep/orchestrate_overnight.sh > phase6_upstream_pr_prep/overnight.log 2>&1 &
set -u
WS=/root/torchtitan_attention_residual
PRETRAIN_OUT=$WS/phase5_vlm_multimodal_sft/runs/vlm_447m_pretrain
SFT_OUT=$WS/phase5_vlm_multimodal_sft/runs/vlm_447m_sft_pretrain
...
LOG="$WS/phase6_upstream_pr_prep/overnight_sft.log"
...
bash "$WS/phase6_upstream_pr_prep/launch_8gpu_mm.sh" >>"$LOG" 2>&1
sft_rc=$?
