...
OUT_DIR="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/v12_4d_fsdp2_dp2_pp2_ep2_continue_8gpu_from_p4_step8000"

mkdir -p "$OUT_DIR"
LOG="$WORKSPACE_DIR/phase6_upstream_pr_prep/v12_orchestrator.log"
exec >>"$LOG" 2>&1
