...
OUT_DIR="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/v12_4d_447m_aligned_continue_from_step12500"

mkdir -p "$OUT_DIR"
LOG="$WORKSPACE_DIR/phase6_upstream_pr_prep/v12_447m_orchestrator.log"
exec >>"$LOG" 2>&1
...
while [[ $attempt -lt $MAX_RETRIES ]]; do
    ...
    # phase6_upstream_pr_prep/DISK_DISCIPLINE.md for why this guard is mandatory.
