...
#      alignment report at phase6_upstream_pr_prep/alignment_report_arm2_real_mm.txt.
#
...
ARM1_DIR="${WORKSPACE_DIR}/phase5_vlm_multimodal_sft/runs/arm1_fsdp"
...
if pgrep -f "phase5_vlm_multimodal_sft.train_mm" >/dev/null 2>&1; then
    echo "[$(date)] [stage 0] WARNING: phase5_vlm_multimodal_sft.train_mm still running, killing"
...
torchrun \
    ...
    --module kimi_k3 --config kimi_linear_436m_block_attn_res_n4 \
