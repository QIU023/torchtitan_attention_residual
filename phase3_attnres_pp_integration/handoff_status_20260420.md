...
Workspace:
- `phase3_attnres_pp_integration/adapter_design.md` — open-unknowns section updated to reflect
  resolved items and chosen implementation strategy.
- `phase3_attnres_pp_integration/handoff_status_20260420.md` — this file.
...
```
rm -rf phase3_attnres_pp_integration/runs/pp8_adapter
source /venv/main/bin/activate
bash phase3_attnres_pp_integration/launch_8gpu_adapter.sh          # 1000 steps, adapter ON
python phase3_attnres_pp_integration/compare_pp_vs_single.py \
    --single phase2_attnres_baseline_loss/runs/attn_res/tb \
