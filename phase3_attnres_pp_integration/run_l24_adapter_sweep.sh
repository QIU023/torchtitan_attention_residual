...
cd "$WS"
LOG="$WS/phase3_attnres_pp_integration/run_l24_adapter_sweep.log"
exec >>"$LOG" 2>&1
...
STEPS=30 \
SWEEP_OUT_ROOT="$WS/phase3_attnres_pp_integration/runs/l24_adapter_nsweep_$(date +%Y%m%d-%H%M%S)" \
