...
cd "$WS"
LOG="$WS/phase3_attnres_pp_integration/run_all_pp_pressure.log"
exec >>"$LOG" 2>&1
...
SWEEP_OUT_ROOT="$WS/phase3_attnres_pp_integration/runs/pressure_test_${TS}_L16fill" \
...
SWEEP_OUT_ROOT="$WS/phase3_attnres_pp_integration/runs/pressure_test_${TS}_L48sweep" \
