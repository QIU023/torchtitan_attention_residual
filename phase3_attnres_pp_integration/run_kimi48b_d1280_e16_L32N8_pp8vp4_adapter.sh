...
cd "$WS"
LOG="$WS/phase3_attnres_pp_integration/run_kimi48b_d1280_e16_L32N8_pp8vp4_adapter.log"
> "$LOG"
exec >>"$LOG" 2>&1

OUT="$WS/phase3_attnres_pp_integration/runs/kimi48b_d1280_e16_L32N8_pp8vp4_adapter_$(date +%Y%m%d-%H%M%S)"
rm -rf "$OUT"

echo "==============================================================="
echo "[$(date)] kimi 48B-layout d1280 e16 L32 N8 PP=8 VP=4 adapter START"
echo "==============================================================="
