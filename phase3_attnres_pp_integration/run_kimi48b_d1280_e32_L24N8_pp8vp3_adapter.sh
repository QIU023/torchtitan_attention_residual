...
cd "$WS"
LOG="$WS/phase3_attnres_pp_integration/run_kimi48b_d1280_e32_L24N8_pp8vp3_adapter.log"
> "$LOG"
exec >>"$LOG" 2>&1

OUT="$WS/phase3_attnres_pp_integration/runs/kimi48b_d1280_e32_L24N8_pp8vp3_adapter_$(date +%Y%m%d-%H%M%S)"
rm -rf "$OUT"
...
(cd torchtitan && \
 env TORCHTITAN_ATTNRES_CACHE=1 ATTNRES_DBG=0 \
     ...
     torchrun \
         ...
         -m torchtitan.train \
         --module kimi_k3 --config kimi_linear_48b_block_attn_res_d1280_e32_L24_N8 \
         --training.steps 300 \
