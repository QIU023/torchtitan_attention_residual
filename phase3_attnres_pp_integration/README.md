...
```bash
bash phase3_attnres_pp_integration/go_8gpu.sh
```
...
scp -r phase3_attnres_pp_integration/ experiments-attn_res/ rental:~/work/
...
python phase3_attnres_pp_integration/fake_pg_test.py

# 3. 8-GPU naive PP, 500 steps
NGPU=8 bash phase3_attnres_pp_integration/launch_8gpu_naive.sh

# 4. 8-GPU adapter, 500 steps (expect same loss, lower comm time)
NGPU=8 TORCHTITAN_ATTNRES_CACHE=1 bash phase3_attnres_pp_integration/launch_8gpu_adapter.sh

# 5. Compare
python phase3_attnres_pp_integration/compare_pp_vs_single.py \
    --single phase3_attnres_pp_integration/runs/single_reference/tb \
    --pp phase3_attnres_pp_integration/runs/pp8_naive/tb \
    --pp_cached phase3_attnres_pp_integration/runs/pp8_adapter/tb
```
