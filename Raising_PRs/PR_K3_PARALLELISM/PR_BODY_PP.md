...
PR 4312. PR branch `k3_pp_text` = `66601a7fb` since 2026-09-11 (moved with lease from `75045fed5`, which was 19 commits on upstream/main `6e2ac3dcd`); that head is `pp_review4`: the same runtime minus the two transport commits, plus round 3, rebased onto main `d9ca9e55a` (23 commits). The transport port alone is `k3_pp_transport` = `8126172f8`, stacked on it. GitHub has reported the PR unmergeable since PR 4527 landed on 2026-09-09.
