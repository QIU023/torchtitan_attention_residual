...
- The rank-shared cache: one `RankLocalCache` per rank (`pipeline_adapter.py:140-290`, `RankLocalCache`), shared by its $V$ virtual stages, keyed (micro-batch, producer stage, commit index).
