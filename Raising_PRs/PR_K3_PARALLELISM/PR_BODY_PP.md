...
PR 4312. PR branch `k3_pp_text` = `75045fed5` (2026-09-09; `pp_review4` = `9bd39bd40` is the same tree with the top commit reworded): 19 commits on upstream/main `6e2ac3dcd`. GitHub has reported the PR unmergeable since PR 4527 landed on 2026-09-09.
