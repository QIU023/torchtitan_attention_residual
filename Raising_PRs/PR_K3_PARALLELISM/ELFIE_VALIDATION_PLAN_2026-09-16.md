...
- One-node holdings quoted below were measured on the morning head `8e0ae8381` (`phase13_k3like_48b_posttrain/K3_INT_20260916.md`); the seeded matrix on `45ed0e3c1` reruns tonight and the numbers get refreshed here.
