...
| --- | --- | --- | --- | --- |
| #4312 text PP | `k3_pp_text` = `pp_review4` = `1c1a88e3e` (PR head moved 2026-09-11 with lease on `75045fed5` to `66601a7fb`, plus the split-injection regression test); the earlier review head was `c6cea394e` (round-2 head `a3be242bf` + 6 commits: Tianyu's 2026-09-11 code comments); transport split out to `k3_pp_transport` = `b815e03fc` | main `6e2ac3dcd` (2026-09-04) | `REPLY_4312_2026-09-11.md` (18 replies + top-level), `REPLY_4312_NUMERICS_2026-09-11.md` (#19: three controls, order-only noise floor, step-1 per-layer profile), `PR_BODY_PP.md` (review round 3) | the user pastes the replies and decides the debug-model depth (#1) and whether the transport stays out; every cell bitwise between the two heads |
