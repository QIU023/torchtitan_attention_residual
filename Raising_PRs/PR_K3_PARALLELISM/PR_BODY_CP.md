...
The PR composes with data parallelism and, optionally, expert parallelism; TP x CP is the TP PR's matter. The matrix below ran on `edc4cd71b` with attention-gym `b19162e` on 2026-09-05 (dp1 and cp2 are bitwise the same on attention-gym upstream/main `7418529`, 2026-09-05, and on `61a73ca6c`, checked 2026-09-06); every step-1 loss is bitwise the pre-merge recipe's, the later steps carry the merged kernels' rounding. The dp rows come with their expert-parallel twins and dp x cp at world 8.
