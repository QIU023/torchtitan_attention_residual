...
- `tests/unit_tests/cpu/test_kimi_k3_attention_residual_init.py`: the projections are zero initialised; at zero the aggregation returns the mean of its sources; the projection still gets a gradient and the norm weight does not.
