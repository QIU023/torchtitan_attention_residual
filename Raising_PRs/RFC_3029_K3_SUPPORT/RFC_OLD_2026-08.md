...
**Yiqiao Qiu** — Member of Technical Staff, Cloud Infrastructure - Fireworks AI [LinkedIn](https://www.linkedin.com/in/yiqiao-qiu-12013723a/)
...
- **(Fix merged) A shared-code gradient fix fell out of the matrix**: TP-without-EP legs under-reduced gradients below the routed experts (3.10x whole-model grad_norm gap, invisible in loss -- Adam is scale-invariant); root cause in the shared MoE sharding config, reproduces on unmodified deepseek_v3, filed as #4054.
...
- Full [Kimi K3 report](https://github.com/MoonshotAI/Kimi-K3/blob/main/k3_tech_report.pdf)
- Attention Residual 
...
Previous `Block Attn Res` only [RFC](https://github.com/QIU023/torchtitan_attention_residual/blob/main/RFC_ATTN_RES_only.md) with comprehensive results for Block Attn Res experiments and implementations for PP adapter was archived in this link.

K3 pre-release status [RFC](https://github.com/QIU023/torchtitan_attention_residual/blob/main/phase13_k3like_48b_posttrain/RFC_K3_SUPPORT_DRAFT.md) with plans and scopes initially planned before alignments with K3 official info.