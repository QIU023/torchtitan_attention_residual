...
The split patches (`split_2026-09-17/`) are still generated against `upstream/main` = `67858929` and head `549c1e21`; they are regenerated once the image-cell findings land, so the rebase and the fixes are one pass rather than two.
