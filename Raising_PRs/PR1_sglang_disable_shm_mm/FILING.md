...
🟢 **Force-pushed 2026-06-06 (`origin/yiqiaoq/disable-shm-mm` @ `8f861043e4`); PR not yet opened on GitHub.**

| Item | Link / value |
|---|---|
| Fork branch | https://github.com/QIU023/sglang/tree/yiqiaoq/disable-shm-mm |
| Open-PR URL | https://github.com/QIU023/sglang/pull/new/yiqiaoq/disable-shm-mm |
...
> **Force-pushed to `origin/yiqiaoq/disable-shm-mm` (`f98e867c02`).** The PR diff is
