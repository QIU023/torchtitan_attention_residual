...
## 2026-09-10: on PR 4312's branch

`k3_pp_text` (PR 4312) now carries the two transport commits: `fd7ff7400` (edge-communicator warm-up) and `75045fed5` (the port of @elfiegg's fix, the commit message naming her and https://github.com/pytorch/torchtitan/pull/4281/changes/2c81784c18b186e201197d97d9f2425cfad5bef0). `k3_pp_mm` (PR 4381) was restacked on it: `c87097ae5` = `75045fed5` + the two DEP commits (CPU: 27 tests). `PR_BODY_PP.md` gained a "Transport (round 3)" section for the body update.
