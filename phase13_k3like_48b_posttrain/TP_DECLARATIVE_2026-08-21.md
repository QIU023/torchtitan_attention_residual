...
2026-08-22 的 58 格:0 fail;无 TP **37/37 逐位相同**;非 LoRA 带 TP **14/14 与上一轮一致**
(证明 LoRA 修复没有外溢);LoRA 带 TP **7/7 变化**,方向正确。
归档 `gate_logs/gate_58_2026-08-22_lorafix_percell.txt`。
