...
cd /workspace && TITAN=/tmp/wt_int0917 VENV=/workspace/venv_bfx9 PYPRE=$S:/workspace/pylib/attn_gym_main CFG=kimi_k3_debugmodel \
...
tp2_cp2_pp2|8|cpmm_probe|kimi_k3_mm_allgather_kv_cp2_pp2_min96|$TP2 --parallelism.no-enable-sequence-parallel --parallelism.num_pp_microbatches 16" $M/mx4.sh int0917
echo "MATRIX DONE"
