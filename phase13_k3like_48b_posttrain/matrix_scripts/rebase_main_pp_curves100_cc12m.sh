...
export SEED_ROOT=/workspace/.mx3_seeds_main33 SEED_CFG=kimi_k3_debugmodel MEASURE_STEPS=100
...
TITAN=/tmp/wt_pprun33 CFG=kimi_k3_debugmodel_cc12m BATCH="$B" \
CELLS="dp1|1|$D 1
pp2_vp4|2|$D 1 $P 2 $L 4 $IL
pp8_vp4|8|$D 1 $P 8 $L 1 $IL" $MX pp3c100cc_pp
TITAN=/tmp/wt_pprun33 CFG=kimi_k3_debugmodel_cc12m_pp_naive BATCH="$B" \
