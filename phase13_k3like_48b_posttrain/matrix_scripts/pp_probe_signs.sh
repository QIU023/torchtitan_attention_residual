...
OUT=/workspace/ppprobe8_$(date +%m%d_%H%M); mkdir -p $OUT; DUMP=$OUT/dumps; mkdir -p $DUMP
...
python $MS/pp_step10_census.py "dp1 vs dp1, fresh compile caches (same cell)" $DUMP/dp1_A $DUMP/dp1_B
