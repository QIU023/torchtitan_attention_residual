...
# 20 % / 40 % of the rows once. 4 GPUs. Set TT (pp_review4 + the rowtokens patch), OUT.
...
table c4r64_dp1 c4r64_dp1_rev c4r64_dp1_ns c4r64_pp2 c4r64_vp2c c4_vp2n
echo; echo '# c4 (64-token rows), 512 tokens per step (4 x 64 per rank), reference dp2'
table c4r64_d2_dp2 c4r64_d2_ep2 c4r64_d2_pp2 c4r64_d2_vp2c c4_d2_vp2n
