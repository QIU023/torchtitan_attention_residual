...
# optional EP cell. spmd_types is the default there (4446 removed the pin).
set -uo pipefail
...
TITAN=/tmp/wt_cprun5 CFG=kimi_k3_debugmodel_mm BATCH="$B" CELLS="dp1|1|$D 1
dp2|2|$D 2" $MX cp5_base
