...
export CUDA_VISIBLE_DEVICES=2,3 TRITON_CACHE_DIR=/workspace/.triton_k3int_recheck
CELLS="dp1|1|$D 1 $S
tp2|2|$D 1 $T 2 $S" $MX k3int_recheck
cat /workspace/mx3_k3int_recheck_*/results.txt
echo "RECHECK DONE"
