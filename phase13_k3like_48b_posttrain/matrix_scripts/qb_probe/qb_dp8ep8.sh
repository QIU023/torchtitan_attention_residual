...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 TRITON_CACHE_DIR=/workspace/.triton_qb100_dp8 TITAN=/tmp/wt_qbrun4 CFG=kimi_k3_debugmodel_probe BATCH="$B" CELLS="dp8_ep8_ctrl|8|$D 8 $E 8 $PD" $MX qb100_dp8ep8_ctrl
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 TRITON_CACHE_DIR=/workspace/.triton_qb100_dp8 TITAN=/tmp/wt_qbrun4 CFG=kimi_k3_debugmodel_qb_probe BATCH="$B" CELLS="dp8_ep8_qb|8|$D 8 $E 8 $PD" $MX qb100_dp8ep8_qb
