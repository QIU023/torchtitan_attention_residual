...
- AttnRes primitive + a Kimi-Linear port (KDA via `fla-core`, MLA, MoE) with FSDP2 / TP / EP parallelization — [implementation](https://github.com/QIU023/torchtitan/tree/fab8ebf24/torchtitan/experiments/kimi_k3).
...
- CPU unit tests for the primitive, model, and pipeline adapter — [tests](https://github.com/QIU023/torchtitan/tree/fab8ebf24/torchtitan/experiments/kimi_k3/tests).
