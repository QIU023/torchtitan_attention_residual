...
- AttnRes primitive + a Kimi-Linear port (KDA via `fla-core`, MLA, MoE) with FSDP2 / TP / EP / CP (correctness-first; CP+TP not yet composable) parallelization — [implementation](https://github.com/QIU023/torchtitan/tree/f76b3ae9a/torchtitan/experiments/kimi_k3), [parallelism + CP verification](https://github.com/QIU023/torchtitan_attention_residual/blob/main/phase13_k3like_48b_posttrain/EIGHTCARD_VERIFICATION_2026-07-21.md).
