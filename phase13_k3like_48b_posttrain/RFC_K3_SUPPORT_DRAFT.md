...
- AttnRes primitive + a Kimi-Linear port (KDA via `fla-core`, MLA, MoE) with FSDP2 / TP / EP / CP parallelization; CP is Ulysses-style (all-to-all seq<->head inside each attention module) and composes with TP, PP, FSDP and EP (3D TPxCPxPP verified on 8 GPUs) — [implementation](https://github.com/QIU023/torchtitan/tree/0f37ec4a/torchtitan/experiments/kimi_k3), [parallelism verification](https://github.com/QIU023/torchtitan_attention_residual/blob/main/phase13_k3like_48b_posttrain/EIGHTCARD_VERIFICATION_2026-07-21.md), [CP x TP x PP verification](https://github.com/QIU023/torchtitan_attention_residual/blob/main/phase13_k3like_48b_posttrain/CP_TP_3D_VERIFICATION_2026-07-24.md).
