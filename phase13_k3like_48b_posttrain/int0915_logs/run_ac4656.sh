...
set -uo pipefail
T=/tmp/wt_ac_4656; OUT=/workspace/.smoke_int0915/ac4656_$(date +%H%M%S); mkdir -p $OUT
...
run ac_none 0 activation-checkpoint:none &
run ac_selective 1 &
run ac_full 2 activation-checkpoint:full &
