...
rm -rf /tmp/wt_verl_0915/checkpoints/verl_grpo_example_gsm8k_0217/grpo-k3-resume
...
echo "A rc=$?"; ls /tmp/wt_verl_0915/checkpoints/verl_grpo_example_gsm8k_0217/grpo-k3-resume/ 2>/dev/null
cp /workspace/grpo-k3-resume.log /workspace/.smoke_int0916/grpo-k3-resumeA.log
...
echo "B rc=$?"; cp /workspace/grpo-k3-resume.log /workspace/.smoke_int0916/grpo-k3-resumeB.log
