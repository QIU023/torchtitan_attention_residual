...
TITAN=/tmp/wt_ppbalrun33 CFG=kimi_k3_debugmodel_pp_balance BATCH="$B" \
CELLS="pp2_vp4_balance|2|$D 1 $P 2 $L 4 $IL" $MX ppbal33_pp
K3_PPBAL_KEEP_LOCAL=1 TITAN=/tmp/wt_ppbalrun33 CFG=kimi_k3_debugmodel_pp_balance BATCH="$B" \
CELLS="pp2_vp4_balance_keeplocal|2|$D 1 $P 2 $L 4 $IL" $MX ppbal33_pp_keeplocal
echo "PPBAL33 MATRIX DONE"
