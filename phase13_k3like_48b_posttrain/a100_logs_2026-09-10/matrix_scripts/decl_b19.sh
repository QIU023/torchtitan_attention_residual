...
export SEED_ROOT=/workspace/.mx3_seeds_main SEED_CFG=kimi_k3_debugmodel CUDA_VISIBLE_DEVICES=6,7 TRITON_CACHE_DIR=/workspace/.triton_decl_b19 PYPRE=/tmp/attn_gym_up
...
dp1|1|$D 1 $S
dp2|2|$D 2 $S
dp2_ep2|2|$D 2 $E 2 $S" $MX decl_b19
TITAN=/tmp/wt_declrun CFG=kimi_k3_debugmodel_tc BATCH="$B" \
CELLS="dp1_tc|1|$D 1
dp2_tc|2|$D 2
dp2_ep2_tc|2|$D 2 $E 2" $MX decl_tc_b19
echo "DECL MATRIX B19 DONE"
