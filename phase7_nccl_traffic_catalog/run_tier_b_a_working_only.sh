...
ORCH_LOG="$WORKSPACE_DIR/phase7_nccl_traffic_catalog/orchestrator_tiers_working.log"
...
for d in "$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/8gpu_a2_"*/tier_{a,b}_trace; do
    [[ -d "$d" ]] || continue
