...
V11_CKPT="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/v11_4d_fsdp2_pp2_tp2_ep2_continue_8gpu_from_p4_step8000/checkpoint/step-5000"
OUT_DIR="$WORKSPACE_DIR/phase5_vlm_multimodal_sft/runs/sft_v11_llava_instruct_150k_4d"
...
mkdir -p "$OUT_DIR"
LOG="$WORKSPACE_DIR/phase9_post_training_ppo_trace/sft_orchestrator.log"
exec >>"$LOG" 2>&1
...
while [[ $attempt -lt $MAX_RETRIES ]]; do
    ...
    # phase5_vlm_multimodal_sft/train_mm.py reads.
    OUT_DIR="$OUT_DIR" \
    FSDP=2 DP_REP=1 PP=2 TP=2 CP=1 EP=2 V=2 ADAPTER=1 \
    PP_MICROBATCH=8 \
    STEPS=490 LOCAL_BS=160 GLOBAL_BS=320 SEQ_LEN=579 \
    MM_GLOBAL_SEQ_LEN=579 \
