...
Both 9-A and 9-B traces feed into `phase7_nccl_traffic_catalog/extract_collectives.py +
...
```
phase9_post_training_ppo_trace/run_sft_pretrain.sh        # SFT entry, modeled on run_v11
phase9_post_training_ppo_trace/multimodal_sft_dataset.py  # LLaVA-Instruct conversational format
phase9_post_training_ppo_trace/run_ppo_smoke.sh           # OpenRLHF launcher
phase9_post_training_ppo_trace/openrlhf_config.yaml       # 4-model + mesh setup
```
