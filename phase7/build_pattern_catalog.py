#!/usr/bin/env python3
"""Build phase7/pattern_catalog.md from all collected NCCL traces.

Walks ``phase5/runs/8gpu_*/tier_{a,b,c}_trace/collective_summary.csv``
...
def main() -> int:
    ...
    lines.append("")
    lines.append(
        "Auto-generated from `phase7/extract_collectives.py` outputs across "
        "all `phase5/runs/8gpu_*/tier_{a,b,c}_trace/collective_summary.csv` "
