...
Takes a source ``ixia_config.json`` (emitted by ``phase7/flows_to_ixia.py``
...
::
    ...
    python phase7/scale_ixia_to_dc.py \\
        --source phase5/runs/v11_4d_fsdp2_pp2_tp2_ep2_continue_8gpu_from_p4_step8000/tier_b_trace/ixia_config.json \\
        --preset llama3-405b-16k \\
        --link-bandwidth-gbps 400 \\
        --out phase7/scaled_configs/v11_pretrain_to_llama3-405b-16k.json
"""
